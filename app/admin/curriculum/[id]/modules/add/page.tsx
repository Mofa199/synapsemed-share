      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-2 text-sm text-gray-600 mb-4">
            ...
            <ChevronRight className="w-4 h-4" />
            <span className="text-[#213874] font-medium">Add Module</span>
          </div>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-3xl font-bold text-[#213874]">Create New Module</h1>
                <p className="text-gray-600">Add a new learning module to the curriculum</p>
              </div>
            </div>
            ...
            <div className="lg:col-span-2 space-y-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Basic details about the learning module</CardDescription>
                </CardHeader>
