...
export default function AddMnemonicPage() {
    ...
    try {
      ...
      if (response.ok) {
        toast({
          ...
          description: "The mnemonic has been created successfully",
        });
      ...
      toast({
        title: "Error",
        description: "Failed to create mnemonic",
        variant: "destructive"
      });
    } finally {
      setLoading(false);
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <Card>
        <CardHeader>
          <CardTitle>Add New Mnemonic</CardTitle>
        </CardHeader>
        <CardContent>
