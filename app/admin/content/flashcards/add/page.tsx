...
import { Save, X, ArrowLeft, BookOpen } from "lucide-react"
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-[#213874]">Add New Flashcard</h1>
          <p className="text-gray-600 mt-2">Create a new flashcard for students</p>
        </div>
            ...
            <div className="lg:col-span-2 space-y-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Enter the front and back content for your flashcard</CardDescription>
                </CardHeader>
