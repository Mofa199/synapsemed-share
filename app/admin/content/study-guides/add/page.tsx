...
export default function AddStudyGuidePage() {
  const { user } = useAuth()
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.success) {
        toast({
          title: "Success",
          description: "Study guide created successfully",
        })
        router.push('/admin/content/study-guides')
      } else {
        throw new Error(data.error || 'Failed to create study guide')
      }
    } catch (error) {
      console.error('Error creating study guide:', error)
      toast({
        title: "Error",
        description: error instanceof Error ? error.message : "Failed to create study guide",
        variant: "destructive",
      })
    } finally {
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-[#213874]">Create Study Guide</h1>
              <p className="text-gray-600">Add a comprehensive study guide for students</p>
            </div>
          </div>
        </div>
            ...
            <div className="lg:col-span-2 space-y-6">
              <Card>
                ...
                <CardContent className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <Input
                      id="title"
                      placeholder="e.g., Cardiovascular System Mastery"
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea
                      id="description"
                      placeholder="Comprehensive description of the study guide..."
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Define the structure and content of your study guide</CardDescription>
                </CardHeader>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Required background knowledge for this study guide</CardDescription>
                </CardHeader>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Available materials and tools in this study guide</CardDescription>
                </CardHeader>
                <CardContent className="space-y-3">
            ...
            <div className="space-y-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Control the study guide availability</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="flex items-center justify-between">
                    <div>
                      <Label htmlFor="isActive">Active</Label>
                      <p className="text-sm text-gray-600">Make study guide available to students</p>
                    </div>
                    <Switch
                      id="isActive"
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>How the study guide will appear</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-3">
                    <div>
                      <h4 className="font-semibold text-[#213874]">{formData.title || "Study Guide Title"}</h4>
                    ...
                    <div className="text-sm space-y-1">
                      <div>Duration: {formData.estimatedHours} hours</div>
                      <div>Chapters: {chapters.filter(c => c.title.trim()).length}</div>
                    </div>
                  </div>
                </CardContent>
              </Card>
